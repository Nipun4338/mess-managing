...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
  <div class="sidebar-brand-text mx-3">Mess</div>
</a>
...
<li class="nav-item">
  <a class="nav-link" href="balance_info.php">
    <i class="fas fa-fw fa-chart-area"></i>
    <span>Balance Info</span></a>
</li>
<li class="nav-item">
  <a class="nav-link" href="month.php">
    <i class="fas fa-fw fa-chart-area"></i>
    <span>Month Info</span></a>
</li>
<li class="nav-item">
  <a class="nav-link" href="meal_info.php">
    <i class="fas fa-fw fa-chart-area"></i>
    <span>Meal Info</span></a>
</li>
<li class="nav-item">
  <a class="nav-link" href="cost_info.php">
    <i class="fas fa-fw fa-chart-area"></i>
